...
## Описание проекта
Проект посвящён разработке мультиспектральной однопиксельной камеры в SWIR-диапазоне и полного AI-пайплайна для повышения разрешения и сегментации дефектов на инфракрасных изображениях.  
Основные целевые приложения — контроль качества пищевых продуктов на конвейерных линиях и исследовательские лабораторные сценарии, где требуется точная локализация мелких и разреженных дефектов.  
Ключевая особенность проекта — сочетание аппаратной реализации мультиспектральной SWIR-однопиксельной визуализации с моделями суперразрешения и семантической сегментации, адаптированными под ограничения реального edge-устройства (Orange Pi 5B).
