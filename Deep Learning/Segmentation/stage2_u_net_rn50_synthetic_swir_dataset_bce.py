...
import shutil
shutil.make_archive('/kaggle/working/checkpoints_u-net-rn50-stage2', 'zip', '/kaggle/working/checkpoints')
...
os.makedirs('stage2-U-Net-rn50-predictions', exist_ok=True)
...
for idx in tqdm(range(num_viz), desc="Saving visualizations", total=num_viz):
    ...
    save_path = f'stage2-U-Net-rn50-predictions/{save_name}'
    plt.savefig(save_path, dpi=150, bbox_inches='tight')
    plt.close()

import shutil
shutil.make_archive('stage2-U-Net-rn50-predictions', 'zip', 'stage2-U-Net-rn50-predictions')